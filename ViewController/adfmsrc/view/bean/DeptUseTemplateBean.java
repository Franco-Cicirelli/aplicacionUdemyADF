...
public class DeptUseTemplateBean {
    ...
    public String navigateToEmpsAction() {
        System.out.println("Call to navigate to emp...");
    ...
    public void deptValueChangeListener(ValueChangeEvent valueChangeEvent) {
        System.out.println("The new dept name is:" + valueChangeEvent);
    }
    ...
    public void filterVOActionListener(ActionEvent actionEvent) {
